        ...
        <div className="flex flex-col lg:flex-row gap-8 pb-20">
          ...
          <div className="w-full lg:w-1/3 space-y-6">
            <button
              ...
              className="w-full mb-3 bg-green-500 text-white py-4 rounded-2xl font-black flex items-center justify-center gap-2 hover:bg-slate-900 transition shadow-lg group"
            >
